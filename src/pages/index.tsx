...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`mobile app management administration`}</title>

        <meta
          name="description"
          content="Experience ease and efficiency with Mobile App Management Administration, your ultimate solution for overseeing and controlling your mobile applications."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1601972602237-8c79241e468b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHB8ZW58MHx8fHwxNjk1MzU0OTg1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`mobile app management administration`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience ease and efficiency with Mobile App Management Administration, your ultimate solution for overseeing and controlling your mobile applications.`}
            </Text>
            <Box
